...
func drawPlaylistLine(_ song: Song, i: Int){
  ...
  let durationSize: Int = songDuration.count
...
func drawPlaylistWindow(_ height: Int32, width: Int32){
  ...
  let maxPlaylistLines: Int = Int(height - 3)
